...
namespace Automation  {
	...
	public class UserActivityHook : object {
        ...
        public event KeyEventHandler HotKeyDown;
        ...
        public void LoadHotKeyDown()
        {
            // install Keyboard hook 
            if (hKeyboardHook == 0)
            {
                KeyboardHookProcedure = new HookProc(NEW_KeyboardHookProc_NEW_CHANGE_MY_NAME);
      ...
      //  private int NEW_KeyboardHookProc_CHANGE_MY_NAME(int nCode, Int32 wParam, IntPtr lParam)
      //  {
      ...
      //  }
		...
		public void Start()
		{
			...
			if(hMouseHook == 0)
			{
                ...
                MouseHookProcedure = new HookProc(MouseHookProc_New);

                //This is only a temp. Place within new UserActivityHook class
                //MouseHookProcedure = new HookProc(MouseHookProc);
        ...
        private int MouseHookProc_New(int nCode, Int32 wParam, IntPtr lParam)
        {
            //ENTERING NEW CODE
            ...
            // raise MouseDown
            if (MouseDown != null && (wParam == WM_LBUTTONDOWN || wParam == WM_RBUTTONDOWN || wParam == WM_MBUTTONDOWN))
            {
                clickCount = 1;
            ...
            // raise MouseUp
            if (MouseUp != null && (wParam == WM_LBUTTONUP || wParam == WM_RBUTTONUP || wParam == WM_MBUTTONUP))
            {
                clickCount = 1;
                MouseButtons button = MouseButtons.None;
            ...
            //END OF ENTERING NEW CODE. BELOW IS THE ORIGNAL METHOD

            // if ok and someone listens to our events
            //if ((nCode >= 0) && (OnMouseActivity != null))
            if(MouseMoved != null && (wParam == WM_MOUSEMOVE))
            {
                MouseButtons button = MouseButtons.None;
                int clickCount2 = 0;
        ...
        private int NEW_KeyboardHookProc_NEW_CHANGE_MY_NAME(int nCode, Int32 wParam, IntPtr lParam)
        {
            // it was ok and someone listens to events
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
