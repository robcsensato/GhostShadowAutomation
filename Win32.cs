...
namespace Automation
{
    public class Win32
    {
        ...
        //Use to set interval for 'theDoubleClickTimer' 
        ...
        [DllImport("User32.dll")]
        public static extern int GetWindowName(IntPtr hWnd);
        ...
        //This is used to send text to TEXTBOX controls
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        public static extern IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, string lParam);

        //This one is used for sending mouse clicks to buttons
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
